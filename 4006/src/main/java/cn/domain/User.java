...
public class User  implements Comparable<User>,Serializable{
	...
	public User(Integer id, String username, String password, java.sql.Date loginTime,
			Teacher teacher) {
		this(username,password,loginTime,teacher);
		this.id = id;
	}
	public User( String username, String password, java.sql.Date loginTime,
				 Teacher teacher){
	...
	public User( String username,java.sql.Date loginTime,
				 Teacher teacher){
		this.username = username;
		this.loginTime = loginTime;
		this.teacher = teacher;
